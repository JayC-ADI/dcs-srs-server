...
services:
  dcs-srs:
    ...
    volumes:
      # Mount host directory to container working directory for persistent data
      # This allows access to logs, config files, and other data generated by SRS
      # Change "/docker/dcs-srs" to your preferred host directory path
      - "/docker/dcs-srs:/opt/srs"
